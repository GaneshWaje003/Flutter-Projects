...
void callbackDispatcher(){
  Workmanager().executeTask((task,inputData) async{
    ...
    CollectionReference source = FirebaseFirestore.instance.collection('DailyTasks');
...
void main() async {
  ...
  Workmanager().registerPeriodicTask('1', 'simpleTaskName',frequency: Duration(minutes: 3));
